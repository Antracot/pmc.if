...
function tora_menu_bar() {
	...
	<header id="masthead" class="site-header clearfix" role="banner">
		<div class="container">
			...
			<a href="http://pmc.if.ua"><img style="width: 30px; margin-top: -3px; height: 22px; margin-left: 15px;" src="<?php echo get_template_directory_uri() ?>/implants/impls/supp/us_flag.jpg" alt=""></a>
